...
public class CommonHelpService extends BaseService {
    ...
    public List<HashMap<String, Object>> COMMON_PRC(HashMap<String, Object> param) {
        return mapper.COMMON_PRC(param);
    }
    ...
    public List<HashMap<String, Object>> HELP_PARTNER_BRAND_BONSA(HashMap<String, Object> param) {
        return mapper.HELP_PARTNER_BRAND_BONSA(param);
    }
