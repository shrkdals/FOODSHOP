package com.ensys.sample;

import com.ensys.sample.code.GlobalConstants;
import com.ensys.sample.domain.user.UserService;
import com.ensys.sample.logging.AXBootLogbackMdcFilter;
import com.ensys.sample.security.*;
...
public class AXBootSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public static final String COMMON_UTILITY = "/api/commonutility";
    ...
    public static final String[] ignorePages = new String[]{
            ...
            "/api/v1/users/findId",
            "/api/v1/users/join",
            "/api/v1/users/ensysLoginChk",
            "/jsp/loginTest.jsp",
            "/jsp/loginTest2.jsp",
            "/api/commonutility/tempMethod"
    };
...
//                .authorizeRequests()
//                .antMatchers("/api/commonutility/**").permitAll()
//                .antMatchers("/jsp/joinMember.jsp").permitAll()
//                .and()
                ...
                .authorizeRequests().anyRequest().hasRole(ROLE)
                .antMatchers(HttpMethod.POST, LOGIN_API).permitAll()
                .antMatchers("/jsp/loginTest2.jsp").permitAll()
                .antMatchers("/modelExtractor**").permitAll()
                .and()



                .formLogin().loginPage("/jsp/loginTest2.jsp").permitAll()
                .and()
