...
package com.ensys.sample.diewald_shapeFile.files.shp.shapeTypes;
...
public class ShpMultiPoint extends com.ensys.sample.diewald_shapeFile.files.shp.shapeTypes.ShpShape {
  ...
  public ShpMultiPoint(Type shape_type){
    super(shape_type);
  }
