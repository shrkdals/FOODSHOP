...
var ACTIONS = axboot.actionExtend(fnObj, {
        PAGE_SEARCH: function (caller, act, data) {
            ...
            axboot.ajax({
                type: "POST",
                url: ["commonutility", "getFiDocuFile"],
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "ORGN_FILE_NAME", label: "파일명", width: "*", align: "center", editor: false},
                {key: "FILE_EXT", label: "파일확장자", width: 90, align: "center", editor: false},
                {key: "FILE_BYTE", label: "파일바이트", width: 90, align: "center", editor: false, hidden:true},
