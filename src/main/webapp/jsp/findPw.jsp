...
<ax:set key="title" value="비밀번호 찾기"/>
...
<ax:layout name="base">
    ...
    <jsp:body>
        ...
        <div class="header_wrap">
            ...
            <h1 class="title" style="padding: 25px;"><i class="cqc-browser"></i>비밀번호 찾기</h1>
        </div>
        ...
        <div style="padding: 100px;">
            <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                <div class="left">
                    <h2><i class="cqc-list"></i> 회원가입시 등록된 정보로 비밀번호를 찾을 수 있습니다.</h2>
