...
<ax:layout name="base">
    <jsp:attribute name="script">카드거래내역
        ...
        <script type="text/javascript">
            ...
            var CodeData2 = [];
            tempCode.forEach(function(item,index){
                if(index != 1)
                    CodeData2.push(item)
            });
            $("#job_tp").ax5select({
            ...
            var CodeData = $.SELECT_COMMON_CODE(SCRIPT_SESSION.cdCompany, "CZ_Q0029");   // 사용목적

            var CodeData2 = $.SELECT_COMMON_CODE(SCRIPT_SESSION.cdCompany, "CZ_Q0025");  // 구분 유형
            ...
            var ACTIONS = axboot.actionExtend(fnObj, {
                ...
                PAGE_SAVE: function (caller, act, data) {
                    ...
                    */
                    ...
                    var itemD = fnObj.gridView02.getData();
                    ...
                    if(fnObj.gridView01.getData("selected")[0].ADMIN_AMT != sumD){
                ...
                , STATEMENTMULTI: function (caller, act, data) {
                        ...
                        modal.close({
                            callback : function(){
                                ...
                                if(e.YN == 'Y'){
                                    ...
                                    data = {list : checkList , REMARK : nvl(e.REMARK,'일괄전표처리') , DT_ACCT_T : e.DT_ACCT_T, TAX_CD : tax_code_dr};
                                    axboot.ajax({
                                        type: "PUT",
                    ...
                    $.openCommonPopup('bucardDocu', 'userCallBack', '', '', data, 600, 180,_pop_top180);
