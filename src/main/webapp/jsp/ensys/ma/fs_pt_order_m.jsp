        ...
        <script type="text/javascript">
            ...
            var ACTIONS = axboot.actionExtend(fnObj, {
                PAGE_SEARCH: function (caller, act, data) {
                    ...
                    var list = $.DATA_SEARCH('PtOrder','selectH',param).list;
                ...
                ITEM_CLICK : function (caller, act, data) {
                    ...
                    var list2 = $.DATA_SEARCH('PtOrder','selectD',nvl(selected,{}));
                    fnObj.gridView02.target.setData(list2);
                },
                DEL_OK : function(caller, act, data){
        ...
        <div style="width:100%;overflow:hidden">
            <div style="width:99%;overflow:hidden;">
                <div class="ax-button-group" data-fit-height-aside="grid-view-01" id="left_title" name="왼쪽그리드타이틀">
                    ...
                    <div class="right">
                        <button type="button" class="btn btn-info" data-page-btn="DEL_OK" id="DEL_OK" style="width: 130px;"><i
                                class="icon_save"></i>배송완료
                        </button>
                    </div>
