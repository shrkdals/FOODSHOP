        ...
        <script type="text/javascript">
            ...
            var ACTIONS = axboot.actionExtend(fnObj, {
                ...
                ITEM_CLICK: function (caller, act, data) {
                    ...
                    var list = $.DATA_SEARCH('DeliverPartner','selectD',{COMPANY_CD:SCRIPT_SESSION.cdCompany , USER_ID : SCRIPT_SESSION.idUSer, COMT_SP : selected.COMT_SP , COMT_CD : selected.COMT_CD});
                ...
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            ...
                            , {key: "DISTRIB_PT_CD"    , label: "물류거래처코드" , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            , {key: "DISTRIB_PT_NM"    , label: "물류거래처명"   , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            ...
                            , {key: "BEGINING_IN_NUM"  , label: "초기입고수량"	, width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            , {key: "SAFE_STOCK_NUM"   , label: "안전재고수량"	, width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            , {key: "STOCK_NUM"        , label: "재고수량"	    , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            , {key: "ORDR_STAT"        , label: "발주상태"	    , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                        ],
            ...
            fnObj.gridView02 = axboot.viewExtend(axboot.gridView, {
                ...
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                              {key: "COMPANY_CD"       , label: ""                , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            , {key: "DISTRIB_PT_CD"    , label: "물류거래처코드"  , width: 150, align: "left" , sortabled:true , required:true ,  hidden:false , editor: false }
                            , {key: "DISTRIB_PT_NM"    , label: "물류거래처명"    , width: 150, align: "left" , sortabled:true , required:true ,  hidden:false , editor: false }
                            , {key: "ITEM_CD"          , label: "상품코드"	      , width: 150, align: "left" , sortabled:true , required:true ,  hidden:false , editor: false }
                            , {key: "ITEM_NM"          , label: "상품명"		  , width: 150, align: "left" , sortabled:true , required:true ,  hidden:false , editor: false }
                            , {key: "INOUT_SEQ"        , label: "입출고순번"      , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            , {key: "INOUT_TP"         , label: "입출고구분"      , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            , {key: "INOUT_DTE"        , label:	"입출고일자"      , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            , {key: "INOUT_NUM"        , label:	"입출고수량"      , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            ...
                            , {key: "MAKE_PT_CD"       , label:	"제조거래처코드"  , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            , {key: "MAKE_PT_NM"       , label:	"제조거래처코드"  , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            , {key: "DISTRIB_VERIFY_YN", label:	"물류사검증여부"  , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                            , {key: "MAKE_VERIFY_YN"   , label:	"제조사검증여부"  , width: 150, align: "left" , sortabled:true ,  hidden:false , editor: false }
                        ],
                        body: {
                            onClick: function () {
