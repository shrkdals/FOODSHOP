...
<ax:set key="title" value="예적금계좌 도움창"/>
            ...
            fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            {key: "CD_DEPOSIT", label: "예적금코드", width: 100, align: "left", editor: false},
                            {key: "NM_DEPOSIT", label: "예적금명", width: 100, align: "center", editor: false},
                            {key: "NO_DEPOSIT", label: "계좌번호", width: 400, align: "left", editor: false}
                        ],
                        body: {
                            onClick: function () {
