...
<ax:set key="title" value="검색 도움창"/>
<ax:set key="page_desc" value="${PAGE_REMARK}"/>
<ax:set key="page_auto_height" value="true"/>
<%--
                                    #######  PARAMETER [ CD_FIELD ] 꼭 넣어줘야합니다. #######
MA_B000005 : 환종도움창
            ...
            fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            {key: "CD_SYSDEF", label: "명", width: 200, align: "center", editor: false},
                            {key: "NM_SYSDEF", label: "코드", width: "*", align: "left", editor: false},
                            {key: "CD_FLAG1", label: "", width: "*", align: "left", editor: false, hidden: true},
                            {key: "CD_FLAG2", label: "", width: "*", align: "left", editor: false, hidden: true},
                            {key: "CD_FLAG3", label: "", width: "*", align: "left", editor: false, hidden: true}
                        ],
                        body: {
                            onClick: function () {
