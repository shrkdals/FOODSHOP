...
<ax:set key="title" value="거래처 계좌 도움창"/>
            ...
            fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            {key: "NM_BANK", label: "은행", width: 100, align: "left", editor: false, hidden:true},
                            {key: "NO_DEPOSIT", label: "계좌번호", width: "*", align: "left", editor: false},
                            {
                                key: "USE_YN", label: "주사용여부", width: 80, align: "center"
                                , editor: {
