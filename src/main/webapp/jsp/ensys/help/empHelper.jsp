            ...
            fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            {key: "NO_EMP", label: "사원번호", width: 100, align: "center", editor: false},
                            {key: "NM_EMP", label: "사원명", width: 150, align: "left", editor: false},
                            ...
                            {key: "NM_DUTY_RANK", label: "직급명", width: 100, align: "left", editor: false},
                            {key: "NO_EMAIL", label: "이메일", width: 120, align: "left", editor: false}
                        ],
                        body: {
                            onClick: function () {
