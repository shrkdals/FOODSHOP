...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript">
            ...
            if (sendData != null) {
                initData.PT_CD = sendData.PT_CD
                initData.AREA_CD = sendData.AREA_CD
            }
            ...
            var ACTIONS = axboot.actionExtend(fnObj, {
                ...
                PAGE_SEARCH: function (caller, act, data) {
                    ...
                    var data = $.DATA_SEARCH('commonHelp', 'COMMON_PRC' , {PRC_TYPE : 'PT_CATE_SEARCH' , PARAM_STRING_1 : initData.initData.ADM_PT_CD }).list

                    var chkArr = [];
                    var temp2 = [];
                    for (var i = 0; i < temp.length; i++) {
                        chkArr.push(temp[i].CATE_CD);
                    }
                    chkArr = chkArr.join('|');

                    if(temp.length > 0){
                        for (var i = 0; i < data.length; i++) {
                            if (chkArr.indexOf(data[i].CATE_CD) == -1) {
                                temp2.push(data[i])
                            }
                        }
                ...
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            ...
                            ,{key: "CATE_CD", label: "카테고리코드", width: 150, align: "center", hidden:false , editor: false}
                            ,{key: "CATE_NM", label: "카테고리명", width: 150, align: "center", hidden:false , editor: false}
