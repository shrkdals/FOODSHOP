...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript">
            ...
            goPaging_fileBbs_m = function (index) {
                page = index;
                ...
                PAGE_SEARCH: function (caller, act, data) {
                    ...
                    axboot.ajax({
                        ...
                        callback: function (res) {
                            ...
                            var page_viewList = Paging(totalDataCount, paging_size, 5, page, "fileBbs_m"); //Paging(전체데이타수,페이지당 보여줄 데이타수,페이지 그룹 범위,현재페이지 번호,token명)
