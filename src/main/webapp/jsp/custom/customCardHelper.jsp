            ...
            fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
                initView: function () {
                    ...
                    this.target = axboot.gridBuilder({
                        ...
                        columns: [
                            {key: "NO_CARD", label: "카드번호", width: 150, align: "center", editor: false},
                            {key: "NM_CARD", label: "카드명", width: 200, align: "left", editor: false},
                            {key: "NM_ST_CARD", label: "카드구분", width: 200, align: "left", editor: false},
                        ],
                        body: {
                            onClick: function () {
