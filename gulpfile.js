...
gulp.task('axboot-initializr-deploy', function () {
    ...
    gulp.src([
        ...
        .pipe(replace(/import=\"com\.chequer\.axboot\.admin/g, 'import="com.ensys.sample'))
        .pipe(gulp.dest('ax-boot-initialzr/src/main/resources/templates/webapp'));
    ...
    gulp.src([
        ...
        .pipe(replace(/com\.chequer\.axboot\.admin/g, 'com.ensys.sample'))
...
gulp.task('scss', function () {
    ...
    gulp.src(ASSETS_SRC + '/scss/arongi/axboot-1.scss')
        .pipe(plumber({errorHandler: errorAlert}))
...
gulp.task('scss-ie9', function () {
    ...
    gulp.src([
        ASSETS_SRC + '/scss/arongi/axboot.scss',
